...
export function main() {
    ...
    function render() {
        ...
        lightingShader.setVec3("lightPos", radius * Math.cos(currentFrame), lightPos[1], radius * Math.sin(currentFrame));
        ...
        model = mat4.create();
        model = mat4.translate(model, model, vec3.fromValues(radius * Math.cos(currentFrame), lightPos[1], radius * Math.sin(currentFrame)));
