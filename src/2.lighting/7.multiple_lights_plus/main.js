...
export function main() {
    ...
    let lightingShader = new Shader('./colorsVs.vs', './colorsFs.fs');
    let lampShader = new Shader('./lampVs.vs', './lampFs.fs');
    ...
    let diffuseMap = TextureFromFile('container2.png', '.');
    let specularMap = TextureFromFile('container2_specular.png', '.'); // loadTexture('container2_specular', gl.RGBA);//  
    lightingShader.use();
