...
export function main() {
    ...
    function render() {
        ...
        let diffuseColor = vec3.multiply(vec3.create(), lightColor, vec3.fromValues(0.5, 0.5, 0.5));
        let ambientColor = vec3.multiply(vec3.create(), diffuseColor, vec3.fromValues(0.2, 0.2, 0.2));
