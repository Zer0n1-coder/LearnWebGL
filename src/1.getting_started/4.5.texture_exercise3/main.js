define(["require", "exports", "../../Global", "./Shader"], function (require, exports, Global_1, Shader_1) {
    ...
    function main() {
        ...
        Global_1.gl.texParameteri(Global_1.gl.TEXTURE_2D, Global_1.gl.TEXTURE_MIN_FILTER, Global_1.gl.NEAREST);
        Global_1.gl.texParameteri(Global_1.gl.TEXTURE_2D, Global_1.gl.TEXTURE_MAG_FILTER, Global_1.gl.NEAREST);
