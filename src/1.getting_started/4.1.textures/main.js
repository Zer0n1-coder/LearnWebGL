define(["require", "exports", "../../Global", "./Shader"], function (require, exports, Global_1, Shader_1) {
    ...
    function main() {
        ...
        //纹理
        let texture = Global_1.gl.createTexture();
        Global_1.gl.bindTexture(Global_1.gl.TEXTURE_2D, texture);
        ...
        Global_1.gl.texImage2D(Global_1.gl.TEXTURE_2D, 0, Global_1.gl.RGB, Global_1.gl.RGB, Global_1.gl.UNSIGNED_BYTE, img);
