...
export function main(): void {
    ...
    function render() {
        ...
        let camX = Math.sin(curTime) * radius;
        let camZ = Math.cos(curTime) * radius;

        mat4.lookAt(view, vec3.fromValues(camX, 0.0, camZ), vec3.fromValues(0.0, 0.0, 0.0), vec3.fromValues(0.0, 1.0, 0.0));
